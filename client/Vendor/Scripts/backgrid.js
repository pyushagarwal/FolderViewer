...
var HeaderCell = Backgrid.HeaderCell = Backbone.View.extend({
  ...
  removeCellDirection: function () {
    this.removeHeaderCellClass();
    this.column.set("direction", null);
  },

  removeHeaderCellClass : function(){
    this.$el.removeClass("ascending")
  ...
  setCellDirection: function (column, direction) {
    ...
    if (column.cid == this.column.cid){
      if(direction === "ascending"){
        ...
        .find('span').addClass("fa fa-arrow-up");
      }else if (direction === "descending"){
        this.$el.addClass(direction)
        .find('span').addClass("fa fa-arrow-down");
      }else {
        this.$el.addClass(direction)
  ...
  render: function () {
    ...
    var label;
    if(sortable){
      label = $("<button>").text(column.get("label") + ' ')
      .addClass("btn btn-link")
      .append("<span class='sort-caret'></span>");
    } else {
